...
<div class="container-fluid">
    ...
    <div class="databox">${id}</div>
    <div class="databox">${student_no}</div>
    <div class="databox">${first_name}</div>
    <div class="databox">${middle_name}</div>
    <div class="databox">${last_name}</div>
    <div class="databox">${birthdate}</div>
    <div class="databox">${email}</div>
    <div class="databox">${contact_no}</div>
    <div class="databox">${address}</div>
    <div class="databox">${gender}</div>
    <div class="databox">${course}</div>
